...
1. **Etapa 1 (26/09–02/10, ~US$ 340, sem checkout).** Campanha de cadastro no México levando a uma página de "acceso anticipado". A página tem convites de exemplo reais e navegáveis e diz com todas as letras que o editor está em construção e que nada é cobrado agora. Roda em paralelo ao build e decide antes do soft launch:
   - os ganchos;
   - apresentadora de IA ou só demo;
   - se a célula de revenda entra na Etapa 2;
   - o peso de cada evento.

   Se nem a premissa otimista pagar o break-even, a ideia morre antes de gastar o K2.
2. **Etapa 2 (a partir de 05/10).** O MVP vai à venda: front de US$ 9,90 em moeda local, com o preço travado, 4 bumps e sem upsell. São 3 conjuntos ABO (MX · CO+PE+CL · AR+EC+GT+DO) a US$ 70/dia. Marcos: K2 em ~11–13/10; K4 e K5 em 15/11; escala de 28/12 a 28/02; teste de teto em 28/02/2027.
...
- **Taxa da Hotmart:** as réguas usam o modelo antigo (10,95% + US$ 1,49), mas o digest registra o fim da taxa do Player em 21/09/2026. Abrir o detalhe da 1ª venda real (front + bump). Se houver taxa fixa em cada bump, tratar 5,23 como cenário otimista: o alvo cairia para ~4,77.
- **Variações por país:**
  - hispanos nos EUA a US$ 12,90: alvo 6,77, break-even 10,16;
  - AR em USD: se o produtor pagar os 9,5% da conversão de ARS (não verificado), o líquido cai ~US$ 1,1. O alvo de AR vira 4,58 e o break-even, 6,87.
...
- **Página de "acceso anticipado"** no domínio novo, com **3 convites de exemplo reais e navegáveis**: XV años, cumpleaños infantil e baby shower.
  ...
  - São as páginas públicas do convite (D2–D3 do build). Depois viram os exemplos da landing e a matéria-prima dos criativos, então nada é jogado fora.
...
**Por que só o MX:**
- é o maior público (93,5 M no Facebook);
...
**Notas de operação:**
- **D começa 48 h depois das outras.** A conta nova ainda tem pouca confiança, e a revenda é o único ângulo que encosta em "oportunidade econômica". A, B e C precisam estar aprovados e entregando antes.
...
- anúncio com "Muy pronto" tende a receber menos clique, então o CPC sai pior que o real;
- lead de lista de espera tende a comprar menos que o e-mail deixado dentro do editor, então o CPL parece melhor do que vale.
...
| **IA ou só demo** (CPL de B ÷ CPL de A) | Com ~40–100 leads por célula, diferença < 25% é ruído | **B ≤ 0,8× A:** IA em até 1/3 do volume (teto da decisão). **0,8–1,25×:** empate; IA em ≤ 1/6, só para diversificar. **B ≥ 1,25× A**, hook rate ≤ 0,8× ou o dobro de comentários negativos: sem IA na onda 1; reavaliar em janeiro |
| **Revenda entra na Etapa 2?** (CPL de D ÷ CPL de A, nos mesmos dias) | Passa se cumprir tudo: CPL de D ≤ 1,3× o de A; ≥ 40 leads em D; ≥ 50% dos leads de D marcando "Hago invitaciones para otras personas"; zero reprovação | **Passa:** conjunto próprio na Etapa 2, com ≤ 20% da verba. **Falha em qualquer item:** célula fechada, e a licença segue só como o bump B4 |
...
| Alguém paga US$ 9,90 quando existe o grátis e o designer a MXN 89 | Só o K2 responde |
| Prévia → pagamento | K7, comparando com a taxa do Mimo |
| Adesão aos bumps, reembolso e regime de taxa | K3, aos 100 compradores |
| CPM de campanha de venda | Otimizar por compra costuma sair mais caro que por cadastro: refazer o CTR mín. com o CPM da Etapa 2 (K6) |
...
- **MVP vendável** no D11 (~03/10). **Limite: 20/10.** Depois disso, lançar só em 26/12.
...
- **Otimização por Purchase desde o dia 1.** A US$ 70/dia, com CPA de 5–8, saem ~9–13 compras/dia, o que basta. Otimizar por um evento do meio do funil compra clique barato que não paga.
- **ABO com orçamento fixo até o K2.** CBO com dataset novo joga tudo no país e no anúncio mais baratos e esconde a leitura.
- **Público:** amplo, 18+, Advantage+. **Excluir os leads da Etapa 1** até o K2.

| Conjunto | Países | Preço | US$/dia | Anúncios | Por quê |
|---|---|---|---|---|---|
| USO_MX | MX | MXN 169 | 30 | 8 | Maior público e maior densidade de anúncios longevos (Invitio 112,5 d, My Invite 116,3 d, Miboda 108,9 d); OXXO |
| USO_SUR | CO + PE + CL | COP 29.900 · S/ 32,90 · CLP 9.490 | 20 | 8 | Moeda e meios de pagamento locais (PSE/Efecty, PagoEfectivo); 685 anúncios somados [medido]; CL tem renda maior |
| USO_USD | AR + EC + GT + DO | US$ 9,90 | 20 | 8 | AR tem 31,1 M no Instagram e está entre os três maiores mercados em espanhol do Mimo (calibração privada). Conferir o líquido de AR nas primeiras vendas |
| REV (só se passou na Etapa 1) | MX | igual | 15 (≤ 20%) | 4 | Mesmo país em que foi medida. Célula isolada, fora do K2 do B2C |
| **Total** | | | **70 (85 com REV)** ≈ R$ 360–437 | 24–28 | |

**Depois do K2:**
- **Hispanos nos EUA a US$ 12,90**, com ≤ 6% da verba. Não entram antes: a US$ 4/dia não se aprende nada, o CPM é alto e a oferta é própria.
...
|---|---|---|---|
| **K2** | ≥ US$ 400 (R$ 2.056) na célula B2C e ≥ 20 anúncios com ≥ 1.000 impressões. Se faltar anúncio, seguir até US$ 550 | CPA de front **> 7,85** | **Morte** do L02 nesse formato, sem reteste. São ~51 compras; mesmo com erro de −28%, o CPA seria 5,65, ainda acima de 5,23 |
...
**As decisões saem do UTMify.** A Meta serve só para diagnóstico (CPM, CTR, hook, hold), porque a atribuição por visualização dela tende a inflar as compras.
...
| Chargeback | ~0 | — | **> 0,5% = parar.** O limite da Hotmart é ~0,9%, e a conta de produtor é a mesma do Mimo |
...
**Por que separar:**
1. **Risco de política.** O nicho de renda extra e a célula de revenda encostam em "oportunidade econômica". Uma restrição na conta do L02 não pode parar a conta que sustenta mais de R$ 2.600/dia.
2. **Aprendizado.** O comprador é outro: quem organiza uma festa, não quem dá um presente romântico. Otimizar por Purchase no dataset do Mimo misturaria os sinais e os públicos semelhantes, nos dois sentidos.
...
| Perfil pessoal | O mesmo perfil real do usuário como admin. **Não criar um segundo perfil:** a Meta só permite um perfil por pessoa, e um perfil falso derrubado arrasta os portfólios ligados a ele |
...
| Dataset (pixel + API de Conversões) | Novo, com os eventos PageView, ViewContent (abriu um exemplo), Lead, InitiateCheckout e Purchase, deduplicados entre navegador e servidor. Credenciais novas, no mesmo esquema do Mimo |
...
| Backend | Remix com banco, arquivos e funções separados. No D1, conferir que nada aponta para o backend do Mimo |
| UTMify | Dashboard novo, com a conta nova vinculada, o webhook do produto novo, os 12% de imposto, a nomenclatura `INV_` e os parâmetros de URL no padrão já usado no Mimo |
...
A Meta também pode associar ativos por admin, cartão e dispositivo. A separação isola **ativos e aprendizado**, não a identidade. O que protege o Mimo de verdade é o anúncio limpo.
...
- **Não editar anúncio no ar nas primeiras 24 h**, porque cada edição volta para revisão.
...
- **Se a conta for restrita, recorrer.** Abrir outra conta para seguir anunciando o mesmo produto é burla de sistemas e costuma derrubar todos os ativos ligados, inclusive os do Mimo.

## 5. Calendário

| Semana | Datas | Build | Mídia | Decisão |
|---|---|---|---|---|
| S39 | 23–27/09 | **D1:** produtos na Hotmart (em análise), BM, conta, página/IG, domínio, dataset e UTMify. **D2–D3:** convites "Ejemplo" e páginas de lista. **D3:** os 13 criativos | Etapa 1 no ar em 26/09 (A, B, C) | — |
...
| S49–S51 | 30/11–20/12 | Boda pronta até ~20/12; renders antes de 24/12 | Demanda de ~0,7×; só dentro das réguas | — |
| S52 | 21–27/12 | — | Sem teste. **26/12:** lançamento, se o K0 falhou, ou início do reteste do K5 | — |
| S53–S08 | 28/12/2026–28/02/2027 | — | **Janela de escala:** CPM 40–60% menor até ~15/01 (dado dos EUA) e compra de convites para as bodas de fev–mai (MX) e mar–abr (AR) | Reteste do K5 até 20/01; A/B 9,90 × 12,90. **28/02: teste de teto** |
...
- O K2 sai por volta de 11–13/10, antes do CPM de novembro (+41% nos dados dos EUA; LATAM não verificado) e da Black Friday (CPM 2–3×).
...
- **Dezembro:** demanda de ~0,7×, porque as bodas de dezembro já compraram o convite e as posadas ficam com o grátis. Rodar só dentro das réguas e usar o tempo para os criativos de boda.
...
**Janeiro e a "cuesta de enero":** a tese não vale para o L02. "Cuesta de enero" fala da situação financeira de quem vê o anúncio, um atributo pessoal que a Meta proíbe, e o produto é vendido para uso próprio.
- **De onde vem a força de janeiro:** do CPM mais barato e da compra de convites para as bodas de fev–mai (MX) e mar–abr (AR). O H03 ("¿Boda en febrero o marzo?") ganha peso a partir de 28/12.
...
**A ideia continua viva depois da data?** Sim. ~82% dos eventos (XV e infantil) são perenes, e de março a setembro o fator é ~1,0×. Perder outubro custa pouco, porque novembro e dezembro são os piores meses do L02. Duas coisas não se estendem: o teto de US$ 2.000 e o teste de teto em 28/02/2027.
