# Decisão: o que lançar primeiro

**Data:** 22/09/2026. **Base:** 60 ideias na long list, 19 sobreviventes das eliminatórias mais 4 reformulações, scorecard com 3 avaliadores e verificação adversarial, 3 deep dives e um painel de 3 juízes, que votou 3 a 0. Os detalhes estão em `01`–`04`.

## Lançar primeiro: L02 · Invitaciones web, como aposta limitada, não como segundo Mimo

**O produto.** Um editor web: a pessoa monta um convite com envelope animado, fotos, música, contagem regressiva, "Cómo llegar" e RSVP com painel. Cria e vê grátis; paga para publicar (**US$ 9,90** em moeda local: MXN 169 · COP 29.900 · CLP 9.490 · S/ 32,90). Tem 4 bumps de US$ 3,90–6,90, entre eles "+5 invitaciones", a licença para fazer convites para clientes (a porta da renda extra). No lançamento cobre XV años, cumpleaños infantil e baby shower; bodas entram a partir de 28/12. Não terá modelo de amor/presente, para não canibalizar o Mimo. Dossiê: [`03_top3/invitaciones-web.md`](03_top3/invitaciones-web.md).

**Por que este (evidência):**
- **A demanda por convite web pago em ES é real e longeva** [proxy: Biblioteca de Anúncios, ativos em 22/09]:
  - [Invitio](https://www.facebook.com/ads/library/?id=1701673927750048), editor self-service a MXN 599, no ar há ~112 d.
  - [My Invite](https://www.facebook.com/ads/library/?id=1894344334607556), 16 anúncios, ~116 d.
...
- **Tem a melhor conta das 3 finalistas** [estimativa; ROI = faturamento líquido ÷ gasto]:
  ...
  - **CPA máx. para ROI 1,5 = US$ 5,23** em conta BRL (Mimo ~5,60);
  - break-even de US$ 7,85;
  - é a única com laço viral mensurável (100–300 convidados veem cada convite).

## A verdade incômoda (leia antes de construir)
...
Plano de validação completo, com orçamento, conta e pixel separados do Mimo e cortes derivados do break-even: [`04_validacao.md`](04_validacao.md).
